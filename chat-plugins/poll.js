...
exports.commands = {
    ...
    tpoll: function(target, room, user) {
        let tiers = ['[Seasonal]', '1v1', 'Battle Factory', 'Hackmons Cup', 'VGC', 'Random Doubles','Challenge Cup 1v1', 'Little Cup', 'Doubles OU', 'Anything Goes', 'OMotM', 'OverUsed', 'Random Battle', 'Random Monotype', 'UnderUsed', 'NeverUsed', 'RarelyUsed', 'PU', 'Ubers', 'Monotype', 'UU Monotype', 'Mono Type-Bans', '[Gen 1] Random Battle'];
